...
class AppColors {
  ...
  static Color get darkPrimary => basePrimary.withValues(alpha: 0.8);
  static Color get darkOnPrimary => ColorUtils.getContrastingColor(darkPrimary);
  static Color get darkSecondary => baseSecondary.withValues(alpha: 0.8);
  ...
  static Color get info => basePrimary.withValues(alpha: 0.8);
